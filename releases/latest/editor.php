            ...
            <div class="wrapper">
                <ul class="flatten">
                    <li <?php echo $category == 'eventi' ? $selectedClass : ''; ?>>
                        <a title="eventi" href="/editor.php?category=eventi">Eventi</a>
                    </li>
                    <li <?php echo $category == 'foto' ? $selectedClass : ''; ?>>
                        <a title="foto" href="/editor.php?category=foto">Foto</a>
                    </li>
                </ul>
            </div>
        </nav>
            ...
            <?php
                ...
                <ul class="fakeTable">
                    ...
                    <li class="col options">
                        <a title="'.$category.'" href="editor-articles.php?action=edit&id={{ID}}&category='.$category.'" class="edit-btn">
                            <i class="material-icons">edit</i>
                        </a>
                        <a title="'.$category.'" href="editor-articles.php?category='.$category.'&action=delete&id={{ID}}" class="delete-btn">
